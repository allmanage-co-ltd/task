...
import { Tag, Plus, X, Edit2, Check, Trash2, Menu } from "lucide-react";

const Sidebar = ({ tags, onAddTag, onUpdateTag, onDeleteTag }) => {
  ...
  const handleToggleTagSection = () => {
    setIsTagSectionOpen((prev) => !prev);
  };
  ...
  return (
    <div className="flex h-full">
      ...
      >
        ...
        {/* タスクのリストなど他のコンテンツがここに来ます */}
        <div className="p-6">{/* 他のコンテンツをここに配置 */}</div>
      </div>
    </div>
  );
};
